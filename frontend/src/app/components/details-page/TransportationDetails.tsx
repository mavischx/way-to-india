                    ...
                    <div className="col-span-6 text-sm ">
                        <div className='flex justify-between'>
                            ...
                            <div className="text-xs flex gap-1 items-center justify-center">
                                <Star color="#fbe346" weight="fill"/>4.5 Ratings
                            </div>
                        </div>
                        <div className='flex gap-1 text-xs'>
                            <div className='border border-gray-200 rounded-lg p-1 flex gap-1 items-center justify-center'>
                                <User/>{transport.capacity} passengers
                            </div>
                            <div className='border border-gray-200 rounded-lg p-1 flex gap-1 items-center justify-center'>
                                <Van/>Public transport
                            </div>
                            <div className='border border-gray-200 rounded-lg p-1 flex gap-1 items-center justify-center'>
                                <MapPin/>Pick up from <span className='text-[#FF8B02] font-bold'>{transport.pickUpLocation}</span>
                            </div>
                            <div className='border border-gray-200 rounded-lg p-1 flex gap-1 items-center justify-center'>
                                <Clock/>Pick up time: <span className='text-[#FF8B02] font-bold'>{transport.pickUpTime}</span>
                            </div>
                        </div>
